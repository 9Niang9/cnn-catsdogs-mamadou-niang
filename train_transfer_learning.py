...
def main():
    parser = argparse.ArgumentParser(description='Fine-tune a pre-trained ResNet18 on Cats vs Dogs.')
    ...
    plt.close()
    print(f'Model saved to {Path(args.checkpoint_dir) / "transfer_learning_best.pth"}')
    print(f'Plots saved to {plot_dir / "transfer_learning_metrics.png"}')
